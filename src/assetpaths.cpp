...
const char *SFX_PROMOTION       = D_SFX "promotion";
...
const char *IMG_INTRO_SH3_CRUISER  = D_SUB   "SH3_cruiser";
const char *IMG_INTRO_SH3_CRUISER1 = D_SUB   "SH3_cruiser1";
const char *IMG_INTRO_SH3_CRUISER2 = D_SUB   "SH3_cruiser2";
...
const char *IMG_BR10_EXPORT      = D_SUB "br10_export";
...
const char *IMG_BR14_EXPORT      = D_SUB "br14_export";
const char *IMG_BR15_FADE1       = D_GRA "br15_fade1";
const char *IMG_BR15_FADE2       = D_GRA "br15_fade2";
const char *IMG_BR15_FADE3       = D_SUB "br15_fade3";
const char *IMG_BR16_NBAR        = D_SUB "br16_nbar";
const char *IMG_BR1_EXPORT       = D_SUB "br1_export";
const char *IMG_BR2_EXPORT       = D_SUB "br2_export";
const char *IMG_BR3_EXPORT2      = D_SUB "br3_export2";
const char *IMG_BR4_EXPORT3      = D_SUB "br4_export3";
const char *IMG_BR5_EXPORT4      = D_SUB "br5_export4";
const char *IMG_BR6_OK           = D_SUB "br6_ok";
const char *IMG_BR7_E1           = D_SUB "br7_e1";
const char *IMG_BR7_E2           = D_SUB "br7_e2";
const char *IMG_BR8_EXPORT       = D_SUB "br8_export";
const char *IMG_BR9_EXPORT       = D_SUB "br9_export";
...
const char *IMG_SU1_BUILD        = D_SUB "su1_build";
...
const char *IMG_SU1_EXPORT       = D_SUB "su1_export";
...
const char *IMG_SU1_PEOPLE       = D_SUB "su1_people";
...
const char *IMG_SU1_TRI          = D_SUB "su1_tri";
...
const char *IMG_TD2_TR0          = D_SUB "td2_tr0";
...
const char *IMG_TS1_M2_1         = D_SUB "ts1_m2_1";
const char *IMG_TS1_M21          = D_GRA "ts1_m21";
const char *IMG_TS1_M2_2         = D_SUB "ts1_m2_2";
...
const char *IMG_TS1_ST1          = D_SUB "ts1_st1";
const char *IMG_TS1_ST2          = D_SUB "ts1_st2";
const char *IMG_TS1_ST3          = D_SUB "ts1_st3";
const char *IMG_TS1_ST4          = D_SUB "ts1_st4";
const char *IMG_TS1_ST5          = D_SUB "ts1_st5";
const char *IMG_TS1_ST6          = D_SUB "ts1_st6";
const char *IMG_TS1_ST8          = D_SUB "ts1_st8";
...
const char *IMG_TS2_M2_1         = D_SUB "ts2_m2_1";
const char *IMG_TS2_M2_2         = D_SUB "ts2_m2_2";
...
const char *IMG_LD6_LD6_1        = D_NEW "ld6_ld6-1";
